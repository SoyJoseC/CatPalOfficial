...
import pandas as pd
import numpy as np
import catpal.logger as logger
import os
import json
import requests
...
# User Information
user_email = 'edfer2025@gmail.com'
user_password = 'mende2025'
access_token = None
...
def authenticate():
    ...
    res = requests.post(login_url, allow_redirects=False, data={'username': 'edfer2025@gmail.com', 'password': 'mende2025'
    })
...
def get_group_folders(group_id, access_token):
    """
...
def folder_structure(json_folder):
    """
